...
{
    public class SimplyfiedPlaylistModel
    {
        ...
        [JsonProperty("tracks", Required = Required.AllowNull, NullValueHandling = NullValueHandling.Include)]
        public TracksNumberModel Tracks { get; set; } = new TracksNumberModel();
